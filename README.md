...
1. The calculation of pore diameter is based on Perry et al. (https://pubs.acs.org/doi/10.1021/acs.analchem.6b01095), with assumptions on theta angle, 
